      ...
      <div class="white-box">
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                <input type="text" class="form-control" id="en_title" placeholder="{{ __('lang.en_title') }}" name="en_title" value="@if(old('en_title') != null){{ old('en_title') }}@elseif(isset($news)){{$news->en_title}}@endif" required="required">
            </div>
            <div class="input-group">
      ...
      <div class="white-box">
          <div class="row">
              <div class="col-sm-12 col-xs-12">
                ...
                <textarea id="editor1" name="en_details" rows="8" class="form-control" style="resize:vertical;width:100%;" placeholder="{{ __('lang.en_details') }}">@if(old('en_details') != null){{ old('en_details') }}@elseif(isset($news->en_details)){{$news->en_details}}@endif</textarea>
      ...
      <div class="white-box">
          <div class="row">
              <div class="col-sm-12 col-xs-12">
                ...
                <textarea id="editor2" name="ar_details" rows="8" class="form-control" style="resize:vertical;width:100%;" placeholder="{{ __('lang.ar_details') }}">@if(old('ar_details') != null){{ old('ar_details') }}@elseif(isset($news->ar_details)){{$news->ar_details}}@endif</textarea>
